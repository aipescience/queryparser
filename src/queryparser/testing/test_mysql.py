...
def test_mysql_parsing(common_test):
    _test_parsing(MySQLQueryProcessor, common_test)

# class MysqlTestCase(TestCase):
    # pass

    # def test_query000(self):
        # self._test_mysql_parsing(*common_tests[0])

    # def test_query001(self):
        # self._test_mysql_parsing(*common_tests[1])

    # def test_query002(self):
        # self._test_mysql_parsing(*common_tests[2])

    # def test_query003(self):
        # self._test_mysql_parsing(*common_tests[3])

    # def test_query004(self):
        # self._test_mysql_parsing(*common_tests[4])

    # def test_query005(self):
        # self._test_mysql_parsing(*common_tests[5])

    # def test_query006(self):
        # self._test_mysql_parsing(*common_tests[6])

    # def test_query007(self):
        # self._test_mysql_parsing(*common_tests[7])

    # def test_query008(self):
        # self._test_mysql_parsing(*common_tests[8])

    # def test_query009(self):
        # self._test_mysql_parsing(*common_tests[9])
